...
@section('content')
    ...
    @if( (isset($acao)) and (isset($toner)) )
        @if($acao == 'e')
            ...
            {!! Form::label('nome', 'Nome') !!}{!! Form::text('nome', isset($toner->nome) ? $toner->nome : null, ['placeholder' => 'Print Model', 'class' => 'form-control'] ) !!}
            <br>
            <!--botao Editar -->
        ...
        @else
            ...
            <input type="hidden" name="confirma" value="true">
                ...
                {!! Form::label('nome', 'Nome') !!}{!! Form::text('nome', isset($toner->nome) ? $toner->nome : null, ['placeholder' => 'Print Model', 'class' => 'form-control', 'disabled'] ) !!}
            <br>
            <input type="hidden" name="confirma" value="true">
            <!--botao Apagar -->
